...
34. **https的具体实现，怎么确保安全性 加密算法有哪些，如何理解MD5**

35. **URL包括哪三个部分？**

36. **一个机器能够使用的端口号上限是多少，为什么？可以改变吗？那如果想要用的端口超过这个限制怎么办？**
...
40. **RSA加密算法，MD5原理（MD5不算加密算法）**

41. **单条记录高并发访问的优化**

42. **介绍一下ping的过程，分别用到了哪些协议**
    ![](media/image95.png)
    首先假设A ping B
...
51. **web服务器的架构和实现**
52. **get post幂等性**
53. **同一个IP同一个端口可以同时建立tcp和udp的连接吗**
...
54. **DNS怎么回事，如何查找对应的IP地址。DNS用什么协议。广播是怎么回事？**
55. **Cookie与session**
